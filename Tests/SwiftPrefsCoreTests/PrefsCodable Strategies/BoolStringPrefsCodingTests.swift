...
struct BoolStringPrefsCodingTests {
    ...
    final class TestSchema: @unchecked Sendable {
        ...
        @Pref(coding: .boolAsString(.trueFalse(.capitalized)))
        var boolStringTrueFalseCapitalized: Bool?
        @Pref(coding: .boolAsString(.trueFalse(.lowercase)))
        var boolStringTrueFalseLowercase: Bool?
        @Pref(coding: .boolAsString(.trueFalse(.uppercase)))
        var boolStringTrueFalseUppercase: Bool?

        @Pref(coding: .boolAsString(.yesNo(.uppercase)))
        var boolStringYesNoUppercase: Bool?
