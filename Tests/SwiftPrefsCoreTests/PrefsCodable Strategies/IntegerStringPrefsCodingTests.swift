...
struct IntegerStringPrefsCodingTests {
    ...
    final class TestSchema: @unchecked Sendable {
        ...
        @Pref(coding: .intAsString)
        var int_As_String: Int?
        @Pref(coding: .uIntAsString)
        var uInt_As_String: UInt?

        @Pref(coding: .int8AsString)
        var int8_As_String: Int8?
        @Pref(coding: .uInt8AsString)
        var uInt8_As_String: UInt8?

        @Pref(coding: .int16AsString)
        var int16_As_String: Int16?
        @Pref(coding: .uInt16AsString)
        var uInt16_As_String: UInt16?

        @Pref(coding: .int32AsString)
        var int32_As_String: Int32?
        @Pref(coding: .uInt32AsString)
        var uInt32_As_String: UInt32?

        @Pref(coding: .int64AsString)
        var int64_As_String: Int64?
        @Pref(coding: .uInt64AsString)
        var uInt64_As_String: UInt64?

        #if compiler(>=6.1)
        @available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
        @Pref(coding: .int128AsString)
        var int128_As_String: Int128?
        @available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
        @Pref(coding: .uInt128AsString)
        var uInt128_As_String: UInt128?
        #endif
    ...
    func int_As_String() {
        ...
        schema.int_As_String = 9_223_372_036_854_775_807 // Int.max (64-bit system)
        #expect(schema.storage.storageValue(forKey: "int_As_String") as String? == "9223372036854775807")
        #expect(schema.int_As_String == 9_223_372_036_854_775_807)

        schema.int_As_String = -9_223_372_036_854_775_808 // Int.min (64-bit system)
        #expect(schema.storage.storageValue(forKey: "int_As_String") as String? == "-9223372036854775808")
        #expect(schema.int_As_String == -9_223_372_036_854_775_808)
    }
    ...
    func uInt_As_String() {
        ...
        schema.uInt_As_String = 18_446_744_073_709_551_615 // UInt.max
        #expect(schema.storage.storageValue(forKey: "uInt_As_String") as String? == "18446744073709551615")
        #expect(schema.uInt_As_String == 18_446_744_073_709_551_615)
    }
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test
    func int32_As_String() {
        let schema = TestSchema()

        schema.int32_As_String = 2_147_483_647 // Int32.max
        #expect(schema.storage.storageValue(forKey: "int32_As_String") as String? == "2147483647")
        #expect(schema.int32_As_String == 2_147_483_647)

        schema.int32_As_String = -2_147_483_648 // Int32.min
        #expect(schema.storage.storageValue(forKey: "int32_As_String") as String? == "-2147483648")
        #expect(schema.int32_As_String == -2_147_483_648)
    }
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test
    func int64_As_String() {
        let schema = TestSchema()

        schema.int64_As_String = 9_223_372_036_854_775_807 // Int64.max
        #expect(schema.storage.storageValue(forKey: "int64_As_String") as String? == "9223372036854775807")
        #expect(schema.int64_As_String == 9_223_372_036_854_775_807)

        schema.int64_As_String = -9_223_372_036_854_775_808 // Int64.min
        #expect(schema.storage.storageValue(forKey: "int64_As_String") as String? == "-9223372036854775808")
        #expect(schema.int64_As_String == -9_223_372_036_854_775_808)
    }
    ...
    func uInt64AsString() {
        ...
        schema.uInt64_As_String = 18_446_744_073_709_551_615 // UInt64.max
        #expect(schema.storage.storageValue(forKey: "uInt64_As_String") as String? == "18446744073709551615")
        #expect(schema.uInt64_As_String == 18_446_744_073_709_551_615)
    }

    #if compiler(>=6.1)
    @available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
    @Test
    func int128_As_String() {
        let schema = TestSchema()

        schema.int128_As_String = 170_141_183_460_469_231_731_687_303_715_884_105_727 // Int128.max
        #expect(
            schema.storage.storageValue(forKey: "int128_As_String") as String?
                == "170141183460469231731687303715884105727"
        )
        #expect(schema.int128_As_String == 170_141_183_460_469_231_731_687_303_715_884_105_727)
    }
    #endif
    ...
    @available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
    @Test
    func uInt128AsString() {
        let schema = TestSchema()

        schema.uInt128_As_String = 340_282_366_920_938_463_463_374_607_431_768_211_455 // UInt128.max
        #expect(
            schema.storage.storageValue(forKey: "uInt128_As_String") as String?
                == "340282366920938463463374607431768211455"
        )
        #expect(schema.uInt128_As_String == 340_282_366_920_938_463_463_374_607_431_768_211_455)
    }
    #endif
