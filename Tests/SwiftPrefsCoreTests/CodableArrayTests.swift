...
struct CodableArrayTests {
    ...
    func singleJSONString(schema: TestSchema) throws {
        ...
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayA.rawValue) as? String)
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayADefaulted.rawValue) as? String)
    }
    ...
    func singleJSONData(schema: TestSchema) throws {
        ...
        // check underlying storage is as expected
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayB.rawValue) as? Data)
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayBDefaulted.rawValue) as? Data)
    }
    ...
    func arrayOfJSONStringElements(schema: TestSchema) throws {
        ...
        // check underlying storage is as expected
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayC.rawValue) as? [String])
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayCDefaulted.rawValue) as? [String])
    }
    ...
    func arrayOfJSONDataElements(schema: TestSchema) throws {
        ...
        // check underlying storage is as expected
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayD.rawValue) as? [Data])
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.arrayDDefaulted.rawValue) as? [Data])
    }
}
