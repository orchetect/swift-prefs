...
struct UserDefaultsPrefsSchemaTests {
    ...
    struct MockCodablePrefsCoding: CodablePrefsCodable {
        ...
        func prefsEncoder() -> JSONEncoder {
            JSONEncoder()
        }

        func prefsDecoder() -> JSONDecoder {
            JSONDecoder()
        }
    }
    ...
    final class TestSchema: @unchecked Sendable {
        ...
        @Pref(key: Key.foo, coding: MockAtomicPrefsCoding())
        var atomic: Bool?
        @Pref(key: Key.fooDefaulted, coding: MockAtomicPrefsCoding())
        var atomicDefaulted: Bool = true

        @Pref(key: Key.rawRep, coding: MockRawRepresentablePrefsCoding())
        var rawRep: RawEnum?
        @Pref(key: Key.rawRepDefaulted, coding: MockRawRepresentablePrefsCoding())
        var rawRepDefaulted: RawEnum = .one

        @RawRepresentablePref(key: Key.rawFoo)
        var rawRep2: RawEnum?
        @RawRepresentablePref(key: Key.rawBar)
        var rawRepDefaulted2: RawEnum = .one

        @Pref(key: Key.codable, coding: MockCodablePrefsCoding())
        var codable: CodableEnum?
        @Pref(key: Key.codableDefaulted, coding: MockCodablePrefsCoding())
        var codableDefaulted: CodableEnum = .one
        ...
        @Pref(key: Key.jsonCodable, coding: MockJSONCodablePrefsCoding())
        var jsonCodable: CodableEnum?
        @Pref(key: Key.jsonCodableDefaulted, coding: MockJSONCodablePrefsCoding())
        var jsonCodableDefaulted: CodableEnum = .one

        @JSONStringCodablePref(key: Key.codable2)
        var jsonCodable2: CodableEnum?
        @JSONDataCodablePref(key: Key.codable2)
        var jsonCodableDefaulted2: CodableEnum = .one
        ...
        var urlDefaulted: URL = .init(string: "https://example.com")!
        ...
        @Pref(key: Key.stringArray)
        var stringArray: [String]?
        // @Pref(key: Key.anyDict) var anyDict: [String: Any]? // doesn't conform to `PrefsStorageValue`
        @Pref(key: Key.stringDict)
        var stringDict: [String: String]?

        // Atomic (Defaulted)
        @Pref(key: Key.int)
        var intDefaulted: Int = 1
        @Pref(key: Key.string)
        var stringDefaulted: String = "a string"
        @Pref(key: Key.bool)
        var boolDefaulted: Bool = true
        @Pref(key: Key.double)
        var doubleDefaulted: Double = 1.5
        @Pref(key: Key.float)
        var floatDefaulted: Float = 2.5
        @Pref(key: Key.data)
        var dataDefaulted: Data = .init([0x01, 0x02])
        @Pref(key: Key.date)
        var dateDefaulted: Date = ISO8601DateFormatter().date(from: "2025-01-07T05:32:03Z")!
        // @Pref(key: Key.anyArray) var anyArrayDefaulted: [Any] = [123, "a string"] // doesn't conform to `PrefsStorageValue`
        @Pref(key: Key.stringArray)
        var stringArrayDefaulted: [String] = ["a", "b"]
        // @Pref(key: Key.anyDict) var anyDictDefaulted: [String: Any] = ["foo": 123, "bar": "a string"] // doesn't conform to `PrefsStorageValue`
        @Pref(key: Key.stringDict)
        var stringDictDefaulted: [String: String] = ["a": "123", "b": "456"]

        // MARK: Key names derived from variable names

        // Defined Key Implementations

        @Pref(coding: MockAtomicPrefsCoding())
        var x_atomic: Bool?
        @Pref(coding: MockAtomicPrefsCoding())
        var x_atomicDefaulted: Bool = true

        @Pref(coding: MockRawRepresentablePrefsCoding())
        var x_rawRep: RawEnum?
        @Pref(coding: MockRawRepresentablePrefsCoding())
        var x_rawRepDefaulted: RawEnum = .one

        @RawRepresentablePref var x_rawRep2: RawEnum?
        @RawRepresentablePref var x_rawRepDefaulted2: RawEnum = .one

        @Pref(coding: MockCodablePrefsCoding())
        var x_codable: CodableEnum?
        @Pref(coding: MockCodablePrefsCoding())
        var x_codableDefaulted: CodableEnum = .one
        ...
        @Pref(coding: MockJSONCodablePrefsCoding())
        var x_jsonCodable: CodableEnum?
        @Pref(coding: MockJSONCodablePrefsCoding())
        var x_jsonCodableDefaulted: CodableEnum = .one
        ...
        var x_url: URL?
        @Pref(encode: { $0.absoluteString }, decode: { URL(string: $0) })
        var x_urlDefaulted: URL = .init(string: "https://example.com")!
        ...
        @Pref var x_dataDefaulted: Data = .init([0x01, 0x02])
    ...
    func atomicPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func atomicDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func rawRepresentablePrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func rawRepresentableDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func rawRepresentable2PrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func rawRepresentableDefaulted2PrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func codablePrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func codableDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func codable2PrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func codableDefaulted2PrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func jsonCodablePrefsCodable(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func jsonCodableDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func jsonCodable2PrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func jsonCodableDefaulted2PrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func urlPrefKey(schema: TestSchema) throws {
        #expect(schema.url == nil)

        let urlA = try #require(URL(string: "https://apple.com"))
        schema.url = urlA
        #expect(schema.url == urlA)

        let urlB = try #require(URL(string: "https://google.com"))
        schema.url = urlB
        #expect(schema.url == urlB)
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func urlDefaultedPrefKey(schema: TestSchema) throws {
        #expect(schema.urlDefaulted == URL(string: "https://example.com")!)

        schema.urlDefaulted = try #require(URL(string: "https://apple.com"))
        #expect(schema.urlDefaulted == URL(string: "https://apple.com")!)

        schema.urlDefaulted = try #require(URL(string: "https://google.com"))
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func intPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func stringPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func boolPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func doublePrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func floatPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func dataPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func datePrefKey(schema: TestSchema) throws {
        #expect(schema.date == nil)

        let dateA = try #require(ISO8601DateFormatter().date(from: "2025-01-07T05:32:03Z"))
        schema.date = dateA
        #expect(schema.date == dateA)

        let dateB = try #require(ISO8601DateFormatter().date(from: "2025-01-07T05:32:04Z"))
        schema.date = dateB
        #expect(schema.date == dateB)

        schema.date?.addTimeInterval(1.0)
        let dateC = try #require(ISO8601DateFormatter().date(from: "2025-01-07T05:32:05Z"))
        #expect(schema.date == dateC)
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func typedArrayPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func typedDictionaryPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func intDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func stringDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func boolDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func doubleDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func floatDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func dataDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func dateDefaultedPrefKey(schema: TestSchema) throws {
        #expect(schema.dateDefaulted == ISO8601DateFormatter().date(from: "2025-01-07T05:32:03Z")!)

        schema.dateDefaulted = try #require(ISO8601DateFormatter().date(from: "2025-01-07T05:32:04Z"))
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func stringArrayDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func stringDictionaryDefaultedPrefKey(schema: TestSchema) {
    ...
    @available(macOS 14.0, iOS 17.0, watchOS 10.0, tvOS 17.0, *)
    @Test(arguments: schemas)
    func x_atomicPrefKey(schema: TestSchema) {
