...
struct RawRepresentableDictionaryTests {
    ...
    func stringRepresentable(schema: TestSchema) throws {
        ...
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.dictA.rawValue) as? [String: String])
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.dictADefaulted.rawValue) as? [String: String])
    }
    ...
    func intRepresentable(schema: TestSchema) throws {
        ...
        // check underlying storage is as expected
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.dictB.rawValue) as? [String: Int])
        _ = try #require(schema.storage.unsafeStorageValue(forKey: TestSchema.Key.dictBDefaulted.rawValue) as? [String: Int])
    }
}
