...
extension TestContent.Basic {
    enum Root {
        ...
        enum Key8 {
            ...
            static var value: [Any] {
                [valueIndex0, valueIndex1]
            }

            static var valueIndex0: [Any] {
                [valueIndex0Index0]
            }

            static let valueIndex0Index0: String = "string"
            static var valueIndex1: [String: Any] {
                [KeyA.key: KeyA.value, KeyB.key: KeyB.value]
            }
        ...
        enum Key11 {
            ...
            enum KeyB {
                static let key: String = "keyB"
                static var value: [String: Any] {
                    [KeyI.key: KeyI.value, KeyII.key: KeyII.value]
                }
