...
struct PrefsStorageImportableLoadTests {
    ...
    func loadRawReinitializing(storage: AnyPrefsStorage) throws {
    ...
    @Test(arguments: Self.storageBackends)
    func loadRawUpdating(storage: AnyPrefsStorage) throws {
        let newContent: [String: any PrefsStorageValue] = [
            "foo": "new string", // key exists, new value of same type
            "bar": Data([0x01, 0x02]), // key exists, new value of different type incompatible with old type
            "boo": true // new key that doesn't exist
    ...
    @Test(arguments: Self.storageBackends)
    func loadRawUpdatingWithPredicate(storage: AnyPrefsStorage) throws {
        let newContent: [String: any PrefsStorageValue] = [
            "foo": "new string", // key exists, new value of same type
            "bar": Data([0x01, 0x02]), // key exists, new value of different type incompatible with old type
            "boo": true // new key that doesn't exist
    ...
    @Test(arguments: Self.storageBackends)
    func loadUnsafeReinitializing(storage: AnyPrefsStorage) throws {
        let newContent: [String: any PrefsStorageValue] = [
            "foo": "new string", // key exists, new value of same type
            "bar": Data([0x01, 0x02]), // key exists, new value of different type incompatible with old type
            "boo": true // new key that doesn't exist
    ...
    @Test(arguments: Self.storageBackends)
    func loadUnsafeUpdating(storage: AnyPrefsStorage) throws {
        let newContent: [String: any PrefsStorageValue] = [
            "foo": "new string", // key exists, new value of same type
            "bar": Data([0x01, 0x02]), // key exists, new value of different type incompatible with old type
            "boo": true // new key that doesn't exist
